...
import hungteen.craid.platform.IPlayerDataManager;
import hungteen.craid.common.capability.player.IHTPlayerCapability;
import hungteen.craid.util.helper.PlayerHelper;
...
public class PlayerCapabilityManager {
     ...
     * {@link hungteen.craid.common.event.HTPlayerEvents#login(PlayerEvent.PlayerLoggedInEvent)}
     */
    ...
    /**
     * {@link hungteen.craid.common.event.HTPlayerEvents#onPlayerClone(net.minecraftforge.event.entity.player.PlayerEvent.Clone)}
     */
